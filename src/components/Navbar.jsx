...
import PizzaLogo from '../assets/e-logo.webp'
                ...
                <nav className="fixed bg-white  max-w-[95rem] w-full mx-auto px-4 py-[5px] flex flex-wrap basis-full items-center justify-between" aria-label="Global">
                    <Link to={"/"}>
                        <div className="sm:order-1 d-flex items-center  font-semibold dark:text-white" href="#">
                            <img src={PizzaLogo} style={{ width: "60px" }} className='rounded-2xl' alt="" />
                            <span className='d-flex items-center'>
                                <h1 className='text-bold text-2xl fs-3 mx-2'>E</h1>
                                <h1 className='text-bold text-2xl fs-3 text-red-400'>- Shop</h1>
                            </span>
                        </div>
                    </Link>
                    ...
                    <div id="navbar-alignment" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:grow-0 sm:basis-auto sm:block sm:order-2">
                        <div className="flex flex-col gap-4 mt-3 sm:gap-5 sm:flex-row sm:items-center sm:mb-3 sm:ps-5">
                            <Link to={"/"} >
                                <h4 className="sm:font-bold text-red-400 text-[18px] sm:text-[18px] dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" >HOME</h4>
                            </Link>

                            <Link to={"/SpecialM"}>
                                <h4 className="sm:font-bold text-red-400 text-[18px] sm:text-[18px] hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" >SPECIAL CLOTH</h4>
                            </Link>

                            <Link>
                                <h4 className="sm:font-bold text-red-400 text-[18px] sm:text-[18px] hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">CONTANCT</h4>
                            </Link>
                        </div>
                    </div>
                </nav>
